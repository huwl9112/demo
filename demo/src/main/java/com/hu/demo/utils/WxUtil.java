...
import com.hu.demo.entity.WxMessage;
...
public class WxUtil {
    ...
    public static JSONObject getWxUser(String code) {
    ...
    public static void moreSend() {//群发
     ...
     * @Description: TODO
     */
    private static JSONObject getWxUser(String openId, String accessToken) {
     ...
     * @Description: TODO
     */
    public static void pushMessage(WxMessage infoVo) {
        String url = "https://api.weixin.qq.com/cgi-bin/message/template/send?access_token="
              + getAccessToken();
